...
exports.customerRegistration = function(req, callback) { 
    ...
    try {
        ...
        var customerColl = db.collection(inputConstant.customerDbName);
        var countersCol = db.collection(inputConstant.counterDbName);
...
exports.viewCustomer = function(req, callback) {
    try {
        ...
        customerColl.find({"userEntity.primaryMobileNumber":input.mobile,"userEntity.passwordHash":input.password}).toArray (function(err, result) {
            if (err) {
                resJson = {
                    "http_code": "500",
                    "message": "Db error !"
...
exports.removeCustomer = function(req, callback) {
    try {
        ...
        customerColl.remove({"userEntity.primaryMobileNumber":input.mobile,"userEntity.passwordHash":input.password},1, function(err, results) {
            if (err) {
                resJson = {
                    "http_code": "500",
                    "message": "Db error !"
